...
const CardItem = (props) => {
  ...
  const onAddOverlay = async (obj)=>{
    try{
      ...
      if(findOverlay){
        axios.delete(`https://646f1aee09ff19b120869694.mockapi.io/cart/${findOverlay.id}`)
        props.setOverlayItems((over) => over.filter(o=>o.myId !== obj.myId))
      }
      else{
        const {data} = await axios.post('https://646f1aee09ff19b120869694.mockapi.io/cart', obj)
